...
import com.hitglynorthz.mybookshelf.adapters.PublishersAdapter;
...
public class Fragment_Publishers extends Fragment {
    ...
    private MaterialCardView cv_info_no_publishers;
    ...
    private void initViews() {
        ...
        toolbar.setTitle(getString(R.string.bnav_publishers));
    ...
    private void setupLayout() {
        // si se pulsa en el item Editoriales del bottomnavigationview
        ...
        bottomNavigationView.setOnNavigationItemReselectedListener(new BottomNavigationView.OnNavigationItemReselectedListener() {
            ...
            public void onNavigationItemReselected(@NonNull MenuItem item) {
                ...
                if(itemId == R.id.bnav_publishers) {
    ...
    private void setupRecycler() {
        ...
        cv_info_no_publishers = rootView.findViewById(R.id.cv_info_no_publishers);
    ...
    private void initRecycler(int sort) {
        ...
        switch (sort) {
            case 0:
                publisherList.addAll(db.getAllPublishers());
                ll_filter.setVisibility(View.GONE);
                break;
            case 1:
                publisherList.addAll(db.getAllPublishersNBooks());
                ll_filter.setVisibility(View.VISIBLE);
                chip_filter.setText(R.string.action_popup_sort_publishers_nbooks);
                break;
        }
        publishersAdapter = new PublishersAdapter(context, publisherList);
        publishersAdapter.setOnItemClickListener(new PublishersAdapter.ClickListener() {
            @Override
        ...
        publishersAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onChanged() {
                super.onChanged();
                toggleEmptyBooksPublishers(publisherList);
            }
        });
    ...
    // se comprueba el numero de Editoriales
    private void toggleEmptyBooksPublishers(List<Publisher> publisherList) {
        if (!publisherList.isEmpty()) {
            cv_info_no_publishers.setVisibility(View.GONE);
        } else {
            cv_info_no_publishers.setVisibility(View.VISIBLE);
        }
    }
    ...
    public void onCreateOptionsMenu(final Menu menu, MenuInflater inflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                publishersAdapter.getFilter().filter(s);
                return false;
            }
        });
    ...
    private void showPopupMenu() {
        ...
        popupMenu.inflate(R.menu.menu_popup_sort_publishers);
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                int id = item.getItemId();
                switch (id) {
                    case R.id.action_popup_sort_publishers_alpha:
                        initRecycler(0);
                        animRecycler();
                        break;
                    case R.id.action_popup_sort_publishers_nbooks:
                        initRecycler(1);
                        animRecycler();
                        break;
                }
