...
public class PublisherBooksAdapter extends RecyclerView.Adapter<PublisherBooksAdapter.MyViewHolder> {
    ...
    public PublisherBooksAdapter(Context context, List<Book> bookList) {
