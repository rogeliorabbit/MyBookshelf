...
public class MoreAdapter extends RecyclerView.Adapter<MoreAdapter.MyViewHolder> implements Filterable {
    ...
    public MoreAdapter(Context context, List<BookBean> bookList, Fragment_More fragment_more) {
        this.context = context;
        this.bookList = bookList;
        this.fragment_more = fragment_more;
        ...
        holder.cv_book_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FragmentNavigator.Extras extras = new FragmentNavigator.Extras.Builder()
                        ...
                        .build();
                ((MainActivity)context).getMainController().navigate(R.id.action_global_nav_details, bundle, null, null);
            }
        });
    ...
    private void deleteBook(Context context, BookBean book, int pos) {
        ...
        //
        if(bookList.size() > 0) {
            Fragment_More.getInstance().setupUpdateMore(context.getString(R.string.book_details_dialog_delete_deleted));
        } else {
            HomeFragment.getInstance().setupUpdateHome(context.getString(R.string.book_details_dialog_delete_deleted));
        }
        fragment_more.toggleEmptyBooks(bookList);
    }
