...
public class AuthorBooksAdapter extends RecyclerView.Adapter<AuthorBooksAdapter.MyViewHolder> {
    ...
    public AuthorBooksAdapter(Context context, List<Book> bookList) {
